...
import com.example.doan_java_nhom5.adapters.ChatAdapter;
import com.example.doan_java_nhom5.databinding.ActivityChatBinding;
import com.example.doan_java_nhom5.models.ChatMessage;
import com.example.doan_java_nhom5.models.User;
import com.example.doan_java_nhom5.network.ApiClient;
import com.example.doan_java_nhom5.network.ApiService;
...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage() {
        ...
        message.put(Constants.KEY_MESSAGE,binding.inputMassage.getText().toString());
        message.put(Constants.KEY_TIMESTAMP, new Date());
        database.collection(Constants.KEY_COLLECTION_CHAT).add(message);
        if(conversionId != null) {
            updateConversion(binding.inputMassage.getText().toString());
        } else {
            ...
            conversion.put(Constants.KEY_LAST_MESSAGE, binding.inputMassage.getText().toString());
        ...
        ApiClient.getClient().create(ApiService.class).sendMessage(
            ...
            public void onResponse(@Nonnull Call<String> call,@Nonnull Response<String> response) {
                if(response.isSuccessful()){
                    ...
                    showToast("Thông báo đã gửi thành công!");
                }else {
